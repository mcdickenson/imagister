...
icewsSYR <- read.csv("C:/users/ben/dropbox/gdelt-egypt-turkey/EgyptSyriaTurkey.zip Folder/Syria-all.csv",stringsAsFactors=F)
...
newdata <- subsetICEWS("govt","fight","anti",icewsSYR,"Syria","2001-01-01")
newdata <- rbind(newdata,subsetICEWS("anti","fight","govt",icewsSYR,"Syria","2001-01-01"))
